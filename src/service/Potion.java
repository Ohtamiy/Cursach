...
public class Potion extends AbstractService {

	public Potion(MainGui gui, JLabel label, Queue queue, JSlider workTime,
	...
	public void run() {
		int count = 0;
		// поки не кінець роботи або черга не порожня
